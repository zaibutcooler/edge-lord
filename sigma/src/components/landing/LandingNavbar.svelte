    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-14">
        ...
        <div class="flex-shrink-0 xs:w-1/6">
          <a href="#hero" class="text-blue-950 text-md font-semibold">Home</a>
        </div>
        <!-- Menu -->
        <div>
            <div class="flex items-center space-x-4">
              <a href="#about" class="text-blue-950 hover:text-gray-800 px-3 py-2 rounded-md text-sm font-medium">About</a>
